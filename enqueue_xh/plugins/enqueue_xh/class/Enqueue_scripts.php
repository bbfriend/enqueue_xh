 ...
 *
 * These classes were refactored from the CMSimple XH_Scripts and CMSimple
 * script enqueue API.
 *
 * @package BackPress
 * @since r16
...
class XH_Script extends Dependencies {
...
*/
	...
	public function init() {
		/**
		 * Fires when the XH_Scripts instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param XH_Scripts &$this XH_Scripts instance, passed by reference.
		 */
