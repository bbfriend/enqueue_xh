 ...
 *
 * These classes were refactored from the CMSimple WP_Scripts and CMSimple
 * script enqueue API.
 *
 * @package BackPress
 * @since r74
 ...
 * @since r74
 */
class XH_Style extends Dependencies {
	public $base_url;
	public $content_url;
...
*/
	...
	public function __construct() {
		/**
		 * Fires when the XH_Styles instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param XH_Styles &$this XH_Styles instance, passed by reference.
		 */
