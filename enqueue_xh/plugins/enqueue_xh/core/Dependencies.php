 ...
 *
 * Classes were refactored from the XH_Scripts and CMSimple script enqueue API.
 *
 * @package BackPress
 * @uses XH_Dependency
 */
class Dependencies {
	...
	/**
	 * An array of queued XH_Dependency handle objects.
	 *
	 * @access public
	 * @var array
	 */
	...
	/**
	 * An array of XH_Dependency handle objects to queue.
	 *
	 * @access public
	 * @var array
	 */
	...
	/**
	 * An array of XH_Dependency handle objects already queued.
	 *
	 * @access public
	 * @var array
	 */
	...
	public function do_items( $handles = false, $group = false ) {
		...
		foreach ( $this->to_do as $key => $handle ) {
			if ( !in_array($handle, $this->done, true) && isset($this->registered[$handle]) ) {
				 ...
				 *
				 * Example: The extending class XH_Scripts is used to register 'scriptaculous' as a set of registered handles:
	...
	public function add( $handle, $src, $deps = array(), $ver = false, $args = null ) {
		if ( isset($this->registered[$handle]) )
			return false;
		$this->registered[$handle] = new XH_Dependency( $handle, $src, $deps, $ver, $args );
		return true;
	}
	 ...
	 *
	 *
	 * @param array  $queue  An array of queued XH_Dependency handle objects.
	 * @param string $handle Name of the item. Should be unique.
